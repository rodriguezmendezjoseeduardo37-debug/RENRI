        ...
        <div className="space-y-3">
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-background border border-border text-foreground text-sm pl-10 pr-4 py-3 rounded-xl placeholder:text-muted-foreground focus:outline-none focus:border-foreground transition-colors"
                />
            </div>

            <div className="space-y-[1px] max-h-[50vh] overflow-y-auto border border-border rounded-2xl overflow-hidden">
                {filtered.length > 0 ? (
                    filtered.map((product) => (
                        <button
                            ...
                            className="w-full flex items-center justify-between p-3 bg-card hover:bg-foreground/5 text-left transition-colors disabled:opacity-30 disabled:cursor-not-allowed group border-b border-border last:border-b-0"
                        >
