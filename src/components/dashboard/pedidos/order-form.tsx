...
export function OrderForm({ products }: OrderFormProps) {
    ...
    const inputClass =
        "w-full bg-background border border-border text-foreground text-sm px-4 py-3 rounded-xl placeholder:text-muted-foreground focus:outline-none focus:border-foreground transition-colors";
    const labelClass =
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 ml-3">
                                        <button
                                            ...
                                            className="w-6 h-6 flex items-center justify-center liquid-button rounded-lg hover:opacity-80 transition-all"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="w-6 h-6 flex items-center justify-center text-foreground hover:text-foreground transition-colors ml-1"
                                        >
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-6 py-4 text-[11px] font-bold tracking-[0.2em] uppercase liquid-button rounded-full hover:opacity-90 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                >
                    {isSubmitting && (
