...
export const NAV_USUARIO = [
    ...
    { href: "/cliente/explorar", icon: MapPin, label: "EXPLORAR", iconColor: "text-amber-500" },
    ...
    { href: "/cliente/enlazar-negocio", icon: Link2, label: "MIS NEGOCIOS", iconColor: "text-indigo-500" },
];
