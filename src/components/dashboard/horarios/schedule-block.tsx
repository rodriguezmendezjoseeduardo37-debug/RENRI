...
export function ScheduleBlock({ schedule, staffName, onClick, top, height }: ScheduleBlockProps) {
    ...
    return (
        <div
            ...
            className={`absolute left-0 right-0 mx-1 border cursor-pointer overflow-hidden rounded-xl transition-all hover:ring-2 hover:ring-foreground hover:-mx-0 ${bgClass} ${textClass}`}
            style={{
                top: `${top}px`,
                height: `${height}px`,
            }}
