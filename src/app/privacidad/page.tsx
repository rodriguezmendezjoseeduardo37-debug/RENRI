        ...
        <div className="min-h-screen bg-black text-white p-8 md:p-16">
            ...
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <section className="space-y-4 text-sm text-[#888888] leading-relaxed">
                    <h2 className="text-white text-lg font-bold tracking-widest uppercase">1. Recopilación de información</h2>
                ...
                <section className="space-y-4 text-sm text-[#888888] leading-relaxed">
                    <h2 className="text-white text-lg font-bold tracking-widest uppercase">2. Uso de la información</h2>
                ...
                <section className="space-y-4 text-sm text-[#888888] leading-relaxed">
                    <h2 className="text-white text-lg font-bold tracking-widest uppercase">3. Privacidad del comercio electrónico</h2>
