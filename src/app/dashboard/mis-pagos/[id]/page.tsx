        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                ...
                <div className="text-right">
                    ...
                    <p className="mt-2 text-sm font-bold tracking-[0.2em] text-white uppercase">
                        {payment.status}
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[0.9fr_1.1fr] gap-6">
                <div className="border border-[#222222] bg-[#111111] p-6 space-y-5">
                    <div>
                        <p className="text-[10px] font-bold tracking-[0.2em] text-[#777777] uppercase">
                            MONTO
                        </p>
                ...
                <div className="space-y-6">
                    {isPending ? (
                        ...
                        <div className="border border-[#222222] bg-[#111111] p-8 space-y-4 text-center">
                            <p className="text-[11px] font-bold tracking-[0.3em] text-[#888888] uppercase">
                                PAGO COMPLETADO
                            </p>
