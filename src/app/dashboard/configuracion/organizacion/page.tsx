        ...
        <div className="max-w-3xl mx-auto space-y-10">
            ...
            <div className="p-6 border border-border bg-card rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center w-12 h-12 border border-border rounded-xl hover:bg-foreground hover:text-background hover:border-foreground transition-colors"
                >
