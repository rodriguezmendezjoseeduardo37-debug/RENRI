    ...
    return (
        <div className="space-y-8">
            ...
            {lowStockProducts.length > 0 && (
                <div className="flex items-center gap-3 px-5 py-4 bg-card border-l-4 border-foreground rounded-r-xl">
                ...
                {[
                    ...
                    >
                        <div className="flex items-center gap-2 mb-3">
                            <stat.icon className={`w-3.5 h-3.5 ${stat.highlight ? "text-foreground" : "text-muted-foreground"}`} />
                            <span className="text-[9px] font-bold tracking-[0.3em] text-muted-foreground uppercase">
                                {stat.label}
                            </span>
                        </div>
                        <span
                            className={`text-xl font-bold font-mono ${stat.highlight ? "text-foreground" : "text-foreground"
                                }`}
                        >
                            {stat.value}
                        </span>
